        ...
        <div class="col-md-12">
            <div class="card shadow-sm border-0 rounded-lg" style="background-color: white; color: black;">
                <div class="card-header d-flex justify-content-between align-items-center" 
                    ...
                    <h4 class="mb-0" style="font-size: 18px;"><i class="fas fa-history"></i>Teen Patti Result</h4>
                </div>
                        ...
                        <table id="example" class="table table-sm table-hover table-bordered text-center" 
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($bet->number); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($bet->created_at)->format('d-m-Y H:i:s')); ?></td>
                                </tr>
...
<?php echo $__env->make('admin.body.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u609116592/domains/king77.games/public_html/root/resources/views/teenpatti/betresult.blade.php ENDPATH**/ ?>