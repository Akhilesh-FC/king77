...
<div class="container game-container mt-5">
    <input type="hidden" id="game_id" value="<?php echo e($game_id); ?>">
    <input type="hidden" id="games_no" value="<?php echo e($bets[0]->games_no ?? ''); ?>">
        ...
        <div class="col-md-12">
            ...
            <div class="card shadow-lg border-0">
                ...
                <div class="card-body bg-light">
                    ...
                    <form action="<?php echo e(route('aviator.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-5">
                                ...
                                <input type="number" name="game_sr_num" class="form-control" value="<?php echo e($results->game_sr_num + 2); ?>" required>
                            </div>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $userBets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td><?php echo e($bet->uid); ?></td>
                                <td><?php echo e($bet->game_sr_num); ?></td>
                                <td><?php echo e($bet->game_id); ?></td>
                                <td><?php echo e($bet->amount); ?></td>
                                <td><?php echo e($bet->win); ?></td>
...
<script>
    ...
    function fetchData() {
        const gameid = <?php echo e($game_id); ?>;
        fetch('/fetch/' + gameid)
...
<?php echo $__env->make('admin.body.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u609116592/domains/king77.games/public_html/root/resources/views/aviator/result.blade.php ENDPATH**/ ?>