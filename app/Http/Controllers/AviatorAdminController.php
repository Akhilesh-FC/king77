...
$total = DB::table('aviator_bet')
    ->selectRaw('
        ...
        SUM(win - amount) as total_user_profit
    ')
    ->first();

$total_admin_profit = $total->total_amount - $total->total_win_amount;
$total_user_profit = $total->total_user_profit; // ✅ Actual profit (win - amount)
...
$todayData = DB::table('aviator_bet')
    ...
    ->selectRaw('
        ...
        SUM(win) as today_win_amount, 
        SUM(win - amount) as today_user_profit
    ')
    ->first();

$today_admin_profit = $todayData->today_amount - $todayData->today_win_amount;
$today_user_profit = $todayData->today_user_profit; // ✅ Actual profit (win - amount)
