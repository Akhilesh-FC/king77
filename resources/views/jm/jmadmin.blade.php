        ...
        <div class="col-md-10">
            <div style="padding: 30px; background: #fff; border-radius: 12px; box-shadow: 0 4px 14px rgba(0,0,0,0.12);">
                ...
                <form action="{{ route('jm.jm1') }}" method="post">
                    ...
                    @php
                        $cards = [
                            ['type' => 'Heart', 'img' => 'https://demo.globalbet786.live/public/rb/heart.png'],
                            ['type' => 'Spades', 'img' => 'https://demo.globalbet786.live/public/rb/dic_spade.png'],
                            ['type' => 'Diamond', 'img' => 'https://demo.globalbet786.live/public/rb/dic_diamond.png'],
                            ['type' => 'Club', 'img' => 'https://demo.globalbet786.live/public/rb/dic_club.png'],
                            ['type' => 'Face', 'img' => 'https://demo.globalbet786.live/public/rb/face.png'],
                            ['type' => 'Flag', 'img' => 'https://demo.globalbet786.live/public/rb/flag.png'],
                        ];
                    @endphp
