                    ...
                    <tr>
                        ...
                        <div class="dropdown">
                          ...
                          <div class="dropdown-content" style="font-size:12px;">
                            <a href="{{route('indianpay_widthdrawl.success',$item->id)}}">Success</a>
                            <!--<a data-toggle="modal" data-target="#exampleModalCenter{{$item->id}}">Reject</a>-->
                           <a data-toggle="modal" data-target="#exampleModalCenter{{$item->id}}" class="reject-button">Reject</a>
                        </div>
                        </div>
