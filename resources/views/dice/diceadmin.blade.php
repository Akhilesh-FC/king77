        ...
        <div class="col-md-10">
            <div class="white_shd full margin_bottom_30" style="padding: 30px; background: #fff; border-radius: 12px; box-shadow: 0 4px 14px rgba(0, 0, 0, 0.12);">
                ...
                <form action="{{ route('DiceadminWinner.dice_win') }}" method="post">
                    ...
                    @php
                        $cards = [
                            ['type' => 'One', 'img' => 'https://demo.globalbet786.live/public/Dice/dice1.png'],
                            ['type' => 'Two', 'img' => 'https://demo.globalbet786.live/public/Dice/dice2.png'],
                            ['type' => 'Three', 'img' => 'https://demo.globalbet786.live/public/Dice/dice3.png'],
                            ['type' => 'Four', 'img' => 'https://demo.globalbet786.live/public/Dice/dice4.png'],
                            ['type' => 'Five', 'img' => 'https://demo.globalbet786.live/public/Dice/dice5.png'],
                            ['type' => 'Six', 'img' => 'https://demo.globalbet786.live/public/Dice/dice6.png'],
                        ];
                    @endphp
