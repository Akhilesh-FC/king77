...
use App\Http\Controllers\Api\{TrxApiController,IfscApiController,KenoGameController,SpinGameApiController,HotAirBalloonController,HighLowgameApiController,
		...
		Lucky16GameApiController,TriplechanceApiController,FuntargetApiController,ChikangameController};
...
Route::post('/forgot-password/send-otp', [PublicApiController::class, 'forgotPasswordSendOtp']);
Route::post('/forgot-password/verify-otp-update', [PublicApiController::class, 'verifyOtpAndUpdatePassword']);
Route::post('/verify-otp-only', [PublicApiController::class, 'verifyOtpOnly']);
Route::post('/update-password-after-otp', [PublicApiController::class, 'updatePasswordAfterOtp']);

Route::post('/sendAccount-otp', [PublicApiController::class, 'sendAccountOtp']);
Route::post('/verifyAccount-otp', [PublicApiController::class, 'verifyAccountOtp']);
...
//Registered API With OTP
Route::post('/register/send-otp', [PublicApiController::class, 'sendOtp']);
Route::post('/register/verify-otp', [PublicApiController::class, 'verifyOtpAndRegister']);

///Login API
Route::post('login/send-otp', [PublicApiController::class, 'login_send_Otp']);
Route::post('login/verify-otp', [PublicApiController::class, 'login_with_Otps']);
...
Route::post('/update_account',[PublicApiController::class,'updateAccount']);
