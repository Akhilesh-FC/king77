...
use App\Http\Controllers\{AviatorAdminController,UpAndDownController,RedBlackController,KinoController,DiceController,SpinController,jhandimundaController, highlowController,jackpotController,hotairballoonController,TitliadminController,teenadminController,miniroulleteadminController,
						  Lucky12Controller,Lucky16Controller,TripleChanceController,FunTargetController,UsdtDepositController,UsdtWidthdrawController,UsdtController,AndarbaharGameController,DragonAdminController,HeadtailGameController,ChickenController,InidaPayDepositController,IndianPayWidthdrawlController};
...
Route::post('/future-result/store', [FunTargetController::class, 'store'])->name('future_result.store');
...
Route::get('/dragon/{gameid}',[DragonAdminController::class, 'dragon_create'])->name('dragon');
	 Route::get('/dragon_fetch/{gameid}', [DragonAdminController::class, 'dragon_fetchData'])->name('ab_fetch_data');
...
Route::get('/add_notification',[SettingController::class,'add_notification'])->name('add_notification');
    ...
    Route::post('/update-setting',[SettingController::class,'update_setting'])->name('update_setting');
     ...
     Route::post('/payin_reject/{id}',[DepositController::class,'payin_reject'])->name('payin_reject');
     
     //////////////////////india pay depsoit  by akhilesh//////////////////////
     /////////////////////////////////////////////////////////////////////////
      Route::get('/indianpay_deposit-{id}',[InidaPayDepositController::class,'indianpay_deposit_index'])->name('indianpay_deposit');
    Route::post('/indiapay_deposit',[DepositController::class,'indianpay_deposit_store'])->name('indianpay_deposit.store');
    Route::get('/indianpay_deposit-active-{id}', [DepositController::class,'indianpay_deposit_active'])->name('indiapay_deposit.active');
    Route::get('/indianpay_deposit-inactive-{id}',[DepositController::class, 'indianpay_deposit_inactive'])->name('indianpay_deposit.inactive');
    Route::get('/indianpay_deposit-delete/{id}',[DepositController::class, 'indianpay_deposit_delete'])->name('indiapay_deposit.delete');
    Route::post('/indianpay_deposit-update-{id}', [DepositController::class, 'indianpay_deposit_update'])->name('indiapay_deposit.update');
    Route::post('/indianpay_update-setting',[SettingController::class,'indianpay_update_setting'])->name('indianpay_update_setting');
     Route::get('/indianpay_deposit-delete-all',[DepositController::class, 'indianpay_deposit_delete_all'])->name('indiapay_deposit.delete_all');  
    
     Route::post('/indianpay_deposit_success/{id}',[DepositController::class,'indianpay_payin_success'])->name('indianpay_payin_success');
     Route::post('/indianpay_payin_reject/{id}',[DepositController::class,'indianpay_payin_reject'])->name('indiapay_payin_reject');
    ...
    /////Inidanpay akhilesh withdrawl start
    Route::get('/indianpay_widthdrawl/{id}',[IndianPayWidthdrawlController::class,'indianpay_widthdrawl_index'])->name('indianpay_widthdrawl');
    Route::post('/indianpay_widthdrawl',[IndianPayWidthdrawlController::class,'indianpay_widthdrawl_store'])->name('indianpay_widthdrawl.store');
    Route::get('/indianpay_widthdrawl-delete-{id}',[IndianPayWidthdrawlController::class, 'widthdrawl_delete'])->name('indianpay_widthdrawl.delete');
    Route::post('/indianpay_widthdrawl-update-{id}', [IndianPayWidthdrawlController::class, 'indianpay_widthdrawl_update'])->name('indianpay_widthdrawl.update');
    Route::post('/indianpay_only-success-{id}', [IndianPayWidthdrawlController::class, 'indianpay_only_success'])->name('indianpay_widthdrawl.only_success_id');
    Route::post('/indianpay_widthdrawl/reject/{id}', [IndianPayWidthdrawlController::class, 'indianpay_reject'])->name('indianpay_widthdrawl.reject');
    Route::post('/indianpay_widthdrawl-upi-{id}', [IndianPayWidthdrawlController::class,'indianpay_success_by_upi'])->name('indianpay_widthdrawl.upi');


    Route::post('/indianpay_widthdrawl-active-{id}', [IndianPayWidthdrawlController::class,'indianpay_success'])->name('indianpay_widthdrawl.success');
    
    /////////////Inidanpay withdrawl end 
 ...
 Route::get('/mines', [PlinkoBetController::class, 'Mines_Bet_History'])->name('mines_bet_history');
